        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {links.map(({ label, value, href, icon: Icon }) => (
            <a
              ...
              className="group flex items-center justify-between rounded-2xl border border-border bg-background-elevated p-5 transition-colors hover:border-accent/60"
            >
