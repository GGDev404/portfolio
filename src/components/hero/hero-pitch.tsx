    ...
    <section className="relative overflow-hidden border-t border-border">
      <div className="mx-auto grid max-w-[1360px] gap-12 px-[40px] pt-[100px] pb-[140px] lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        <div>
          ...
          <MagneticBlock className="mt-6">
            <p className="max-w-lg text-lg leading-relaxed text-muted">{t("subtitle")}</p>

            <p className="mt-4 flex items-center gap-2 font-mono text-xs uppercase tracking-[0.1em] text-muted">
        ...
        <MagneticBlock className="lg:mt-1">
          <SystemReadout />
        </MagneticBlock>
      </div>
    </section>
